...
public class WasotaProperties {
	...
	final public static String MEX_CORE_DOWNLOAD = "http://wasota.aksw.org/files/mexcore.ttl";
	final public static String MEX_PERF_DOWNLOAD = "http://wasota.aksw.org/files/mexperf.ttl";
	final public static String MEX_ALGO_DOWNLOAD = "http://wasota.aksw.org/files/mexalg.ttl";
...
//	final public static String MEX_ALGO_DOWNLOAD = "http://localhost:3010/files/mexalg.ttl";
